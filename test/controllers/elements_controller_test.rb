...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { element_type: @element.element_type, position: @element.position, section_id: @element.section_id } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { element_type: @element.element_type, position: @element.position, section_id: @element.section_id } }
